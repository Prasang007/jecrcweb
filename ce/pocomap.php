    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <h1 class="section-heading text-highlight"><span class="line">Mapping of CO & PO</span></h1>
                    <p class="text-justify"><div class="container">
                ...
                <table class="des">
                            ...
                            <tr>
							 <tr>
								...
								<td>
								<a href="III sem po and co mapping.PDF" target="_blank"> I SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							 <tr>
                                <td>2.</td>
								...
								<td>
								<a href="III sem po and co mapping.PDF" target="_blank"> II SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
                                <td>3.</td>
								<td>Second Year III Semester</td>
								
								<td>
								<a href="III sem po and co mapping.PDF" target="_blank"> III SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							<tr>
                                <td>4.</td>
								<td>Second Year IV Semester</td>
								
								<td>
								<a href="V sem po and co mapping.PDF" target="_blank"> IV SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>
							<tr>
                                <td>5.</td>
								<td>Third Year V Semester</td>
								
								<td>
								<a href="V sem po and co mapping.PDF" target="_blank"> V SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>
							<tr>
                                <td>6.</td>
								<td>Third Year VI Semester</td>
								
								<td>
								<a href="V sem po and co mapping.PDF" target="_blank"> VI SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>
							<tr>
                                <td>7.</td>
								<td>Fourth Year VII Semester</td>
								
								<td>
								<a href="VII sem po and co mapping.PDF" target="_blank"> VII SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>
							<tr>
                                <td>8.</td>
								<td>Fourth Year VIII Semester</td>
								
								<td>
								<a href="VII sem po and co mapping.PDF" target="_blank"> VIII SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>
