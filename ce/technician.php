                ...
                <div class="row page-row"> 
                    ...
                    <hr>
                        <table class="des">
							...
							<tr>
							<td><img src="../images/ce/Lab Instructor/Ghanshyam.jpg"
                                                     alt="Ghanshyam">
                                </td>
                                <td>Mr. Ghanshyam</td>
                                ...
                                <td>Diploma</td>
                                <td>2</td>
                                <td>ghanshyamchoudhary5050@gmail.com</td>
								<tr>
							<td><img src="../images/ce/Lab Instructor/Hemraj.jpg"
                                                     alt="Hemraj Saini">
                                </td>
                                <td>Mr. Hemraj Saini</td>
                                <td>Lab Technician</td>
                                <td>Diploma</td>
                                <td>2</td>
                                <td>Sainihemraj777@gmail.com</td>
