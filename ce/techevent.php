        ...
        <div class="wrapper">
            ...
            <div class="container content">
                ...
                <table class="des">
                            ...
                            <tr>
                                <td>1.</td>
								<td>Renaissance 2018</td>
								
								<td>
								<a href="Renaissance 2018.PDF" target="_blank"> Events Details</a>
								</td>
                            </tr>	
							<tr>
                                <td>2.</td>
								<td>Jantar Mantar Visit</td>
								
								<td>
								<a href="Jantar Mantar Visit.PDF" target="_blank"> Events Details</a>
								</td>
                            </tr>	
							<tr>
                                <td>3.</td>
								...
								<td>
								<a href="Sewage Treatment Plant.PDF" target="_blank"> Events Details</a>
								<tr>
                                <td>4.</td>
								<td>J- Techtrix</td>
								<td>
								
								<a href="J- Techtrix.PDF" target="_blank"> Events Details</a>
