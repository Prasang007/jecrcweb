    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <!--//main-nav-->
             ...
             <div class="container content" class="col-md-10">

                    <section class="procedure col-md-10">
                    <h1 class="section-heading text-highlight"><span class="line">Course Outcomes</span></h1>
                ...
                <div class="row page-row"> 
                 ...
                 <table class="des">
                            ...
                            <tr>
                                <td>1.</td>
								<td>First Year 1st Semester</td>
								
								<td>
								<a href="1st sem co po map.pdf"> I Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>2.</td>
								<td>First Year 2nd Semester</td>
								
								<td>
								<a href="2nd Sem co po map.pdf"> II Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>3.</td>
								<td>Second Year 3rd Semester</td>
								<td>
								<a href="3rd sem co po map.pdf"> III Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>4.</td>
								<td>Second Year 4th Semester</td>
								<td>
								<a href="4th Sem co po map.pdf"> IV Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>5.</td>
								<td>Third Year 5st Semester</td>
								<td>
								<a href="5th sem CO PO Map.pdf"> V Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>6.</td>
								<td>Third Year 6st Semester</td>
								<td>
								<a href="6th Sem co po map.pdf"> VI Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>7.</td>
								<td>Fourth Year 7th Semester</td>
								<td>
								<a href="7th sem co po map"> VII Semester CO PO Mapping</a>
								</td>
                            </tr>	
							<tr>
                                <td>8.</td>
								<td>Fourth Year 8th Semester</td>
								<td>
								<a href="8th Sem co po map.pdf"> VIII Semester CO PO Mapping</a>
								</td>
                            </tr>	
