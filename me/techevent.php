    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <h1 class="section-heading text-highlight"><span class="line">Technical Events of ECE Departemnt</span></h1>
                ...
                <table class="des">
                            ...
                            <tr>
								...
								<td>
								<a href="EMBRYO.PDF" target="_blank"> Events Details</a>
								</td>
                            </tr>	
							<tr>
                                <td>2.</td>
								...
								<td>
								<a href="CADD MANIA.PDF" target="_blank"> Events Details</a>
								</td>
                            </tr>	
							<tr>
                                <td>3.</td>
								<td>MIGHTY THROTTLE</td>
								
								<td>
								<a href="MIGHTY THROTTLE.PDF" target="_blank"> Events Details</a>
								<tr>
                                <td>4.</td>
								<td>FORK LIFTER</td>
								
								<td>
								<a href="FORK LIFTER.PDF" target="_blank"> Events Details</a>
								<tr>
								<td>5.</td>
								<td>PROPELLO </td>
								<td>
								<a href="PROPELLO.PDF" target="_blank"> Events Details</a>
								<tr>
								</td>
								<tr>
								<td>6.</td>
								<td>CUT 2 DESIGN</td>
								<td>
								<a href="CUT 2 DESIGN.PDF" target="_blank"> Events Details</a>
								<tr>
								</td>
								<tr>
								<td>7.</td>
								<td>R-MECH OLYMPIAD</td>
								<td>
								<a href="R-MECH OLYMPIAD.PDF" target="_blank"> Events Details</a>
								<tr>
								</td>
								<tr>
								<td>8.</td>
								<td>BRAIN QUEST</td>
								<td>
								<a href="BRAIN QUEST.PDF" target="_blank"> Events Details</a>
								<tr>
								</td>
