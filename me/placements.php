    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <h1 class="section-heading text-highlight"><span class="line">Department of ME Placements</span></h1>
                ...
                <table class="des">
                            ...
                            <tr>
								...
								<td>
								<a href="placement16.PDF"> Placements Record</a>
								</td>
                            </tr>	
							<tr>
                                <td>2.</td>
								...
								<td>
								<a href="placement17.PDF"> Placements Record</a>
								</td>
                            </tr>	
							<tr>
                                <td>3.</td>
								...
								<td>
								<a href="placement18.PDF"> Placements Record</a>
								</td>
                            </tr>	
