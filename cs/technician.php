                ...
                <div class="row page-row"> 
                    ...
                    <hr>
                        <table class="des">
							...
							<tr>
							<td><img src="../images/cse/Lab Instructor/Bhupendra.jpg"
                                                     alt="Bhupendra Singh">
                                </td>
                                ...
                                <td>PGDCA</td>
                                <td>10</td>
                                <td>bhupendra.cse@jecrc.ac.in</td>
                                   </tr>
							<tr>
							<td><img src="../images/cse/Lab Instructor/Dilip1.jpg"
                                                     alt="Dilip Kumar Sharma">
                                </td>
                                <td>Mr. Dilip Kumar Sharma</td>
                                <td>Web Developer</td>
                                <td>MCA</td>
                                <td>10</td>
                                <td>dilipkumarsharma.cse@jecrc.ac.in</br> 
								sharma.dilip97@gmail.com </td>
								</tr>
							<tr>
							<td><img src="../images/cse/Lab Instructor/Tovindra.jpg"
                                                     alt="Tovindra Kumar Sahu">
                                <td>Mr. Tovindra Kumar Sahu</td>
                                <td>Sr. Lab Instructor</td>
                                <td>MCA</td>
                                <td>15</td>
                                <td>tovindra@jecrc.ac.in </br>
								tovindra@gmail.com</td>
							</tr>
                            <tr>
							<td><img src="../images/cse/Lab Instructor/Abhay.jpg"
                                                     alt="Abhay Kumar Bhatt">
                                <td>Mr. Abhay Kumar Bhatt</td>
                                <td>Network Administrator</td>
                                <td>MCA</td>
                                <td>19</td>
                                <td>bhattabhay17@yahoo.com</td
							</tr>
                            </tr>
							<tr>
							<td><img src="../images/cse/Lab Instructor/Ramkesh.jpg"
                                                     alt="Ramkesh Meena">
                                <td>Mr. Ramkesh Meena</td>
                                <td>Lab Technician</td>
                                <td>M.Com</td>
                                <td>5</td>
                                <td>ramkesh.cse@jecrc.ac.in</td>
								<tr>
							<td><img src="../images/cse/Lab Instructor/Kaushal1.jpg"
                                                     alt="Kaushalendra Nagoria">
                                <td>Mr. Kaushalendra Nagoria</td>
                                <td>Sr.Web Developer</td>
                                <td>MCA</td>
                                <td>6.5</td>
                                <td>kaushaln89@gmail.com</td>
								<tr>
							<td><img src="../images/cse/Lab Instructor/.jpg"
                                                     alt="">
                                <td>Mr. </td>
                                <td></td>
                                <td></td>
