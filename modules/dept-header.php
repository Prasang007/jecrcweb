    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapse">
            <ul class="nav nav-justified">
                <li class="<?php if (preg_match("/index/", $currentPage)) echo "active "; ?>nav-item"><a href="index.php" >About Us </a>
                   <ul class="dropdown-menu animated fadeInRight" role="menu">
                        <!-- <li><a href="aboutdept.php">About Department</a></li>
                        <li><a href="hoddesk.php">HOD's Desk</a></li> -->
                    </ul>
                ...
                <li class="<?php if (preg_match("/admission/", $currentPage)) echo "active "; ?>nav-item dropdown">
                    ...
                    <ul class="dropdown-menu animated fadeInRight" role="menu">
                        <li><a href="peo.php">Program Education Objective</a></li>
                      <!--  <li><a href="#">Program Outcomes</a></li>-->
                        <li><a href="po.php">PO’s</a></li>
                        <li><a href="co.php">CO’s (Odd and Even Semester)</a></li>
                        <li><a href="pocomap.php">PO and CO mapping</a></li>

                    </ul>


                </li>
                <li class="<?php if (preg_match("/events/", $currentPage)) echo "active "; ?>nav-item"> <a href="techevent.php" >Technical Events </a>
                   <!-- <a href="#" class="dropdown-toggle" data-delay="0" data-toggle="dropdown" data-hover="dropdown" data-close-others="false">Tech. Events<i class="fa fa-angle-down"></i></a> -->
                    <ul class="dropdown-menu  animated fadeInRight" role="menu">
                        <li><a href="techevent.php">Technical Event-1</a></li>
                     <!--   <li><a href="#">Java Lets</a></li>
                        <li><a href="#">Bussiness Plan</a></li> -->
                    </ul> 
...
<!-- data-toggle="dropdown" role="button" aria-expanded="false" -->
  ...
  <li><a href="technician.php">Technical Staff</a></li>
                ...
                <li class="<?php if (preg_match("/about/", $currentPage)) echo "active "; ?>nav-item"><a href="placements.php">Placements</i></a>
