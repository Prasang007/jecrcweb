<header class="header">
    ...
    <div class="header-main container" id="sticky-nav">
        <h1 class="logo col-md-4 col-sm-4">
            <a href="index.php"><img id="logo" src="images/campus/logojecrc.jpg" alt="Logo"></a>
        </h1><!--//logo-->
        <div class="info col-md-8 col-sm-8">
          <h4 class="top-rec"><b>Our Top Recruiters</b></h4>
          <div class="pull-right" style="width: 90%;">
              <div id="scroller" style="width:90%; height: 50px">
              </div>
            </div><!--//contact-->
        </div><!--//info-->
