            ...
            <div class="container">
                ...
                <div class="row page-row"> 
                    <header class="page-heading clearfix">
                        <h1 class="title pull-left">IT Faculty Members</h1>
                    ...
                    <hr>
                        <table class="des">
                            ...
                            <tr>
							 <td><img src="../images/it/faculty/hod_img.jpg "
                                                     alt="Dr. Lokesh Kumar Bansal">
                                </td>
                                <td>Mr. sunil Jangir</td>
                                <td> Head</td>
                                <td>M.tech</td>
                                <td>9</td>
                                <td>5</td>
                                <td>hod.it@jecrc.ac.in</td>
                                <td>Dr.suniljangir@example.com</td>
								</tr>
								<tr>
									<td><img src="../images/it/faculty/naveenkedia.png "
                                                     alt="Mr. Naveen Kedia">
                                </td>
                                <td>Mr. Naveen Kumar Kedia</td>
                                <td>Assistant professor</td>
                                <td>M.Tech</td>
                                <td>13</td>
                                <td>4</td>
                                <td>naveenkedia.it@jecrc.ac.in</td>
                                <td>naveen@test.com</td>
								</tr>
								<tr>
								
                                <td><img src="../images/it/faculty/swati.png "
                                                     alt="Rajesh Kumar Bathija">
                                </td>
                                <td>Ms. Swati Vijay</td>
                                <td>Assistant Professor</td>
                                <td>M.TECH</td>
                                <td>10</td>
                                <td>4</td>
                                <td>swativijay.it@jecrc.ac.in</td>
                                <td>swati@example.com</td>
								</tr>
							<tr>
							<td><img src="../images/it/faculty/kusum.PNG "
                                                     alt="KUSUM YADAV">
                                </td>
                                <td>Ms. Kusum Yadav</td>
                                <td>Assistant professor</td>
                                <td>M.TECH</td>
                                <td>8.5</td>
                                <td></td>
                                <td>kusumyadav.it@jecrc.ac.in</td>
                                <td>kusum@example.com</td>
								</tr>
								<tr>
							                   <td><img src="../images/it/faculty/preeti.png "
                                                     alt="Preeti">
                                </td>
                                <td>Ms. Preeti Sharma</td>
                                <td>Assistant Professor</td>
                                <td>M.TECH</td>
                                <td>6.9</td>
                                <td>4</td>
                                <td>preetisharma.cse@jecrc.ac.in</td>
                                <td>admin@example.com</td>
								</tr>
								<tr>
								 <td><img src="../images/it/faculty/shweta.png "
                                                     alt="Shweta">
                                </td>
                                <td>Ms. Shweta Saxena</td>
                                <td> Assistant professor</td>
                                <td>M.Tech</td>
                                <td>3.10</td>
                                <td>4</td>
                                <td>Shweta.saxena20oct@gmail.com  </td>
