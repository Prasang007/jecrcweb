    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <p class="text-justify">The Departments of Electronics & Communication Engineering and Electrical Engineering are the major departments involving number of laboratories with a diversified variety of equipment being the core branches and with laboratories focusing on fundamental aspects of Electronics & Communication Engineering. In order to cope up with the requirement of industries, the departments also have laboratories with latest technologies. Students have an open access in the laboratories, to understand as well as apply their knowledge to explore their engineering skills. The departments have team of highly motivated and dedicated faculty members to the cause of academics and striving to do the best in the interest of the college and the students. Most of the faculty members are actively involved in research work and regularly publishing their research papers in Journals and Conferences.</p>
