...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->  
    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <!-- ******NAV****** -->
            <?php include '../me/dept-header.php'; ?>
            <!--//main-nav-->

            <div class="container content">

                    <section class="procedure col-md-10">
                    <h1 class="section-heading text-highlight"><span class="line">PEO</span></h1>
                    <p class="text-justify">
1.	To provide students with the fundamentals of Engineering Sciences with more emphasis in Mechanical Engineering by way of analyzing and exploiting engineering challenges.</br></br>
2.	To train students with good scientific and engineering knowledge so as to comprehend, analyze, design, and create novel products and solutions for the real life problems.</br></br>
3.	To inculcate professional and ethical attitude, effective communication skills, teamwork skills, multidisciplinary approach, entrepreneurial thinking and an ability to relate engineering issues with social issues.</br></br>
4.	To provide students with an academic environment aware of excellence, leadership, written ethical codes and guidelines, and the self-motivated life-long learning needed for a successful professional career.</br></br>
