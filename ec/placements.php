    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <h1 class="section-heading text-highlight"><span class="line">Department of ECE Placements</span></h1>
                ...
                <table class="des">
                            ...
                            <tr>
								...
								<td>
								<a href="ECE 2015-2016.PDF"> Placements Record</a>
								</td>
                            </tr>	
							<tr>
                                <td>2.</td>
								...
								<td>
								<a href="ECE 2016-2017.PDF"> Placements Record</a>
								</td>
                            </tr>	
							<tr>
                                <td>3.</td>
								...
								<td>
								<a href="ECE 2017-2018.PDF"> Placements Record</a>
								</td>
                            </tr>	
