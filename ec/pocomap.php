                ...
                <table class="des">
                            ...
                            <tr>
							 <tr>
								...
								<td>
								<a href=".PDF" target="_blank"> I SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							 <tr>
                              <td>2.</td>
								...
								<td>
								<a href=" PDF" target="_blank"> II SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	  
							<td>3.</td>
								...
								<td>
								<a href="co and po map III sem.PDF" target="_blank"> III SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							<td>4.</td>
								...
								<td>
								<a href="co and po map IV sem.PDF" target="_blank"> IV SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
								<td>5.</td>
								...
								<td>
								<a href="co and po map V sem.PDF" target="_blank"> V SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							<td>6.</td>
								...
								<td>
								<a href="co and po map VI sem.PDF" target="_blank"> VI SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							<td>7.</td>
								...
								<td>
								<a href="co and po map VIIsem.PDF" target="_blank"> VII SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
							<td>8.</td>
								...
								<td>
								<a href="co and po map VIII sem.PDF" target="_blank"> VIII SEMESTER CO PO MAPPING</a>
								</td>
                            </tr>	
									</table>
                    <!--//team-wrapper-->
