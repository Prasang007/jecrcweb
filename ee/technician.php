                ...
                <div class="row page-row"> 
                    ...
                    <hr>
                        <table class="des">
                            ...
                            <tr>
                                <td><img src="../images/me/technician/.png "
                                                     alt="Rajendra Singh Naruka">
                                </td>
                                <td>Mr. VISHWAS VERMA</td>
                                <td>Sr. Instructor</td>
...
<tr>
							<td><img src="../images/ee/Lab Instructor/Dileep.jpg "
                                                     alt="Dileep Singh Jadoun">
                                </td>
                                <td>Mr. Dileep Singh Jadoun</td>
                                <td>LAB.TECHNICIAN</td>
                                <td>Diploma</td>
                                <td>1</td>
                                <td>dileepjadoun185@gmail.com</td>
                            </tr>
							</table>
                    <!--//team-wrapper-->
