    ...
    <body onload="StartMove();" class="home-page">
        <div class="wrapper">
            ...
            <div class="container content">
                    ...
                    <h1 class="section-heading text-highlight"><span class="line">Program Education Objective</span></h1>
                    <p class="text-justify"> •	To provide students with the fundamentals of Engineering Sciences with more emphasis in Electrical Engineering by way of analyzing and exploiting engineering challenges .</br>
•	To train students with good scientific and engineering knowledge so as to comprehend, analyze, design and create novel products and solutions for the real life problems.</br>
•	To inculcate professional and ethical attitude, effective communication skills, teamwork skills, multidisciplinary approach, entrepreneurial thinking and an ability to relate engineering issues with social issues.</br>
•	To provide students with an academic environment aware of excellence, leadership, written ethical codes and guidelines, and the self-motivated life-long learning needed for a successful professional career. </br>
